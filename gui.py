...
import wx
# generate pylintrc file to ignore warnings involving wx dynamic methods: pylint --generate-rcfile > .pylintrc
# edit in the [MASTER] part: extension-pkg-whitelist=wx
        ...
        if column_index1 != wx.NOT_FOUND and column_index1 != 0 and \
           column_index2 != wx.NOT_FOUND and column_index2 != 0:
            ...
            if len(df) > 0:
                ...
                self.axes.set_xlabel(df.columns.values[column_index1],fontweight='bold')
                self.axes.set_ylabel(df.columns.values[column_index2],fontweight='bold')
                self.canvas.draw()
...
class MainFrame(wx.Frame):
    ...
    def __init__(self, df):
        wx.Frame.__init__(self, None, -1, "GREEN Monthly Data")
        ...
        self.page4 = LinePlot(nb, columns, self.page1.df_list_ctrl)
        ...
        nb.AddPage(self.page4, "Line Plot")
